...
To learn about the rest of Blockly's development tools, see the [Contribute to Core](/guides/contribute/code/index) 
documentation.  
...
1.  **Check out the `main` branch.** by running `git checkout main` in a 
    terminal. In blockly core and blockly-samples, this branch is named `main`.
