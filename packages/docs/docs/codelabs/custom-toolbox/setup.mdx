...
The initial application has a toolbox definition included in already included in the `toolbox.js` file. 
...
The complete code used in this codelab can be viewed in the `blockly` repository under [packages/docs/docs/codelabs/custom-toolbox](https://github.com/RaspberryPiFoundation/blockly/tree/main/packages/docs/docs/codelabs/custom-toolbox/complete-code).
