...
In this codelab we will provide the block definition for you to copy and use.
...
Just after the import statements, insert the following code in `index.js`, which adds your custom block to the list of available blocks: 
