...
1. Run `npx @blockly/create-package app context-menu-option-codelab` in your terminal. This will create a Blockly application in the folder `context-menu-option-codelab`.
1. Use `cd` to move into the new directory: `cd context-menu-option-codelab`.
...
The complete code used in this codelab can be viewed in the `blockly` repository under [packages/docs/docs/codelabs/context-menu-option/complete-code](https://github.com/RaspberryPiFoundation/blockly/tree/main/packages/docs/docs/codelabs/context-menu-option/complete-code).
...
In `serialization.js`, change the value of `storageKey` to some unique string. `contextMenuWorkspace` will work:
