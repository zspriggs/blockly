...
The complete code used in this codelab can be viewed in the `blockly` repository under [packages/docs/docs/codelabs/css](https://github.com/RaspberryPiFoundation/blockly/tree/main/packages/docs/docs/codelabs/css/complete-code).
...
Take a moment to explore the code you just created in the `css-codelab` folder. If you'd like a more in-depth explanation of all of the code in the sample app, you can go through the [getting started codelab](/codelabs/getting-started/codelab-overview) which goes through creating this sample app from scratch.
